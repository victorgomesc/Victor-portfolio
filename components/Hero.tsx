import { TextGenerateEffect } from '@/lib/TextGenerateEffect'
...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
        ...
        <div className="flex justify-center relative my-20 z-">
            <div className="max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center">
                ...
                <TextGenerateEffect 
                    ...
                    words="Transforming Concepts into Seameless User Experiences"
                />

            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg:text-2xl mt-6">
                Hi! I&apos;m Victor, a Full Stack Developer based in Brasil.
            </p>
